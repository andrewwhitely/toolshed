import { AddPostCard } from '@/components/blog/AddPostCard';
					...
					{filtered.length > 0 ? (
						...
						<div className='text-center py-12 text-[var(--ink3)] flex flex-col items-center gap-3'>
							...
							<p className='text-[11px]'>
								No posts yet. Click 'New Post' below to start planning your next one.
							</p>
							<AddPostCard onClick={() => setEditorOpen(true)} />
						</div>
					)}
				</div>
