	...
	return (
		<div>
			...
			<div className='flex flex-col gap-5 max-w-[800px]'>
				...
				{/* Preferences */}
				<div className='bg-[var(--white)] border-[1.5px] border-[var(--border)] rounded-lg p-4 sm:p-5 transition-colors duration-300 min-w-0'>
					<h3 className='font-serif text-[14px] sm:text-[16px] font-bold text-[var(--ink)] mb-1'>
						Preferences
					</h3>
					<p className='text-[10px] text-[var(--ink3)] mb-4 leading-[1.6]'>
				...
				<div className='bg-[var(--white)] border-[1.5px] border-[var(--border)] rounded-lg p-5 transition-colors duration-300'>
					...
					<div className='mt-4 pt-4 border-t border-[var(--border2)] flex flex-col gap-2.5'>
						...
						<div className='flex flex-col sm:flex-row sm:flex-wrap gap-2.5'>
							<Button variant='danger' onClick={() => setPending('tools')} className='w-full sm:w-auto'>
								🔧 Clear All Tools
							</Button>
							<Button variant='danger' onClick={() => setPending('projects')} className='w-full sm:w-auto'>
								🏗 Clear All Projects
							</Button>
							<Button variant='danger' onClick={() => setPending('all')} className='w-full sm:w-auto'>
								🗑 Clear All Data
							</Button>
						</div>
					</div>
