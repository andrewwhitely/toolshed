...
export function DashboardPage({
	...
	return (
		<div>
			...
			<div className='grid grid-cols-2 sm:grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-3 mb-6'>
			...
			{doable.length > 0 ? (
				<div className='grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(290px,1fr))] gap-3 mb-6'>
					{doable.map((p) => (
						<ProjectCard
							key={p.id}
							project={p}
				...
				<div className='mb-6'>
					<div className='text-center py-6 text-[var(--ink3)]'>
						<div className='text-3xl mb-2'>⚡</div>
						<p className='text-[11px]'>
							Add more tools to unlock projects you can tackle now.
						</p>
					</div>
					<div className='grid grid-cols-2 sm:grid-cols-[repeat(auto-fill,minmax(185px,1fr))] gap-2.5'>
