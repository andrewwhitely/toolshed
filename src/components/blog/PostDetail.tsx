...
export function PostDetail({ post, onBack, onEdit, onDelete }: Props) {
  ...
  return (
    <div className="bg-[var(--white)] border-[1.5px] border-[var(--border)] rounded-md p-4 sm:p-8 max-w-[740px]">
      ...
      <h1 className="font-serif text-[22px] sm:text-[28px] font-black text-[var(--ink)] mb-4 leading-tight">{post.title}</h1>
